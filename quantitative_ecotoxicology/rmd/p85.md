...
The resulting estimates of $k_e$ and $C_0$ are `0.00268` $\pm$ `0.00067` and  `465` $\pm$ `20`.
...
The estimates (`0.00244` $\pm$ `0.00035` and  `455` $\pm$ `38`) are quite similare to the nonweighted regression.
